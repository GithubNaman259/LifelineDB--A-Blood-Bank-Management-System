...
BEGIN
  DBMS_OUTPUT.PUT_LINE('🚀 Procedure started with ' || p_request_id);
  ...
  DBMS_OUTPUT.PUT_LINE('✅ Insert and update complete.');
END;
/
...
BEGIN
  CASE v_choice
    ...
    WHEN 2 THEN insert_patient(112, 'Priya Sen', 'O-', 'Emergency', '9112345678', 1);
    WHEN 3 THEN add_donation(212, 2, TO_DATE('2025-05-02', 'YYYY-MM-DD'), 0.5, 'B+', 1012);
